...
// ============================================================================
// FIXED STAKE RECEIPT CONTRACT (Compatible with SwapPoolFixed)
// ============================================================================

/**
 * @title StakeReceiptFixed
 * @dev Non-transferable receipt tokens for SwapPoolFixed contract
 * @notice This receipt contract uses poolSlotId instead of originalTokenId
 * Key change: Tracks pool slots instead of original token IDs since SwapPoolFixed uses a slot-based system
 */
contract StakeReceiptFixed is ERC721Enumerable, Ownable {
    address public pool;
