  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center z-50 p-4">
          ...
          <div className="w-full">
            ...
            <div className="flex items-center gap-2 mt-2">
              ...
              <span className="text-sm font-semibold text-amber-600 dark:text-amber-400">
                Swap Fee: {poolFee ? `${parseFloat(poolFee).toFixed(2)} S` : 'Loading...'}
              </span>
            </div>
          </div>
        </div>
        ...
        <div className="mt-6 flex gap-3 flex-wrap">
          <a className="inline-flex items-center gap-2 px-4 py-2.5 text-sm font-medium bg-blue-500 hover:bg-blue-600 text-white rounded-lg shadow-md hover:shadow-lg transition-all duration-200" href={`${import.meta.env.VITE_EXPLORER_BASE || 'https://sonicscan.org'}/address/${pool.swapPool}`} target="_blank" rel="noreferrer">
