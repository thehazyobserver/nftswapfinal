...
export default function PoolDetail({ pool, onClose, provider }) {
  return (
    <div className="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center z-50 p-4">
        <div className="bg-card dark:bg-card w-full max-w-4xl max-h-[90vh] overflow-y-auto p-4 sm:p-6 rounded-2xl shadow-xl border border-gray-200 dark:border-gray-700">
        <div className="sticky top-0 bg-white/95 dark:bg-gray-800/95 pb-4 mb-4 border-b border-gray-200 dark:border-gray-700">
