...
var Multicall = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        network = _a.sent();
                        contract = new ethers_1.ethers.Contract(this.getContractBasedOnNetwork(network.chainId), Multicall.ABI, ethersProvider);
                        overrideOptions = {};
                        if (options.blockNumber) {
    ...
    Multicall.prototype.getContractBasedOnNetwork = function (network) {
        ...
        switch (network) {
            ...
            case enums_1.Networks.mantle:
            case enums_1.Networks.mantleTestnet:
            case enums_1.Networks.base:
            case enums_1.Networks.baseTestnet:
            case enums_1.Networks.blastSepolia:
            case enums_1.Networks.polygonZkEvm:
            case enums_1.Networks.polygonZkEvmTestnet:
            case enums_1.Networks.zora:
            case enums_1.Networks.zoraTestnet:
            case enums_1.Networks.flare:
            case enums_1.Networks.pulsechain:
            case enums_1.Networks.scroll:
            case enums_1.Networks.scrollSepolia:
            case enums_1.Networks.sapphire:
            case enums_1.Networks.blast:
            case enums_1.Networks.amoy:
            case enums_1.Networks.mantaPacific:
            case enums_1.Networks.mode:
                return '0xcA11bde05977b3631167028862bE2a173976CA11';
            case enums_1.Networks.modeTestnet:
